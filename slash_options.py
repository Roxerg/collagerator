...
PeriodOption = create_option(
    ...
    required=False,
    choices=[
        create_choice(name="week", value="7day"),
        create_choice(name="month", value="1month"),
        create_choice(name="3month", value="3month"),
        create_choice(name="6month", value="6month"),
        create_choice(name="year", value="12month"),
        create_choice(name="overall", value="overall"),
    ],
)
ListOption = create_option(
    ...
    required=False,
    choices=[
        create_choice(name="artists", value="artists"),
        create_choice(name="tracks", value="tracks"),
